...
namespace WorldCitiesAPI.Controllers
{
    ...
    public class CitiesController : ControllerBase
    {
        ...
        {
            var cities = _context.Cities.AsNoTracking().Select(c => new CityDTO()
            {
                Id = c.Id,
                Name = c.Name,
                Lat = c.Lat,
            ...
            return await ApiResult<CityDTO>.CreateAsync(cities, pageIndex, pageSize, sortColumn, sortOrder, filterColumn, filterQuery);
        }
